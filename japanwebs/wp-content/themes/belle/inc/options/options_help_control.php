...
****************************************************/
	...
	****************************************************/
	...
	function register_canon_options_help () {
		...
		$screen_handle_canon_options_help = add_submenu_page(
			...
			esc_html__('Help Center', 'loc-canon-belle'),						//the submenu title that will appear in browser title area.
			esc_html__('Help', 'loc-canon-belle'),								//the on screen name of the submenu
	...
	****************************************************/
	...
	function display_canon_options_help () {
		require_once get_template_directory() . "/inc/options/options_help.php";
	}