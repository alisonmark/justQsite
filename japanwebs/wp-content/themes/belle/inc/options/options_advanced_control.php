...
****************************************************/
	...
	****************************************************/
	...
	function register_canon_options_advanced () {
		...
		$screen_handle_canon_options_advanced = add_submenu_page(
			...
			esc_html__('Advanced Settings', 'loc-canon-belle'),					//the submenu title that will appear in browser title area.
			esc_html__('Advanced', 'loc-canon-belle'),							//the on screen name of the submenu
	...
	****************************************************/
	...
	function display_canon_options_advanced () {
		require_once get_template_directory() . "/inc/options/options_advanced.php";
	}