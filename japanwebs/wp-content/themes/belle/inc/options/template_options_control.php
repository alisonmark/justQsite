...
****************************************************/
	...
	****************************************************/
	...
	function register_INSPIRE_OPTIONS () {
		...
		$screen_handle_INSPIRE_OPTIONS = add_menu_page(
			...
			'display_INSPIRE_OPTIONS', 											//the function / callback that runs the whole admin page
	...
	****************************************************/
	...
	//display the menus
	function display_INSPIRE_OPTIONS () {
		require_once get_template_directory() . "/inc/options/TEMPLATE_OPTIONS.php";
	}