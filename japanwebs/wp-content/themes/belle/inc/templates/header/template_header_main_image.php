...
<?php 
    ...
    ?>
        ...
        <div class="outter-wrapper header-container image-header-container <?php if ($canon_options_frame['use_sticky_header'] == 'checked') { echo "canon_sticky"; } ?>" data-stellar-background-ratio="<?php echo canon_fw_convert_percentage_to_inverse_ratio($canon_options_frame['header_img_parallax_amount']); ?>">
